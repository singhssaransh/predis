...
public class MainActivityHur extends FragmentActivity implements OnMapReadyCallback, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_equake);
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int j, long l) {
        ...
        switch(vid) {
            ...
            case R.id.spinner2:
            {
                ...
                try {
                    serv = new URL("http://107.170.79.67:8007/hurric/?a="+choice);
